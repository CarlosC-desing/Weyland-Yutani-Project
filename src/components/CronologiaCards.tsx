      ...
      <div className="relative flex flex-col md:flex-row gap-0">
        <div className="relative w-full md:w-64 lg:w-72 shrink-0 aspect-video md:aspect-auto overflow-hidden">
          <img
            src={timeline.image}
            alt={timeline.title}
            className="w-full h-full object-cover transition-all duration-700 ease-in-out lg:grayscale lg:brightness-50 lg:contrast-125 group-hover:lg:grayscale-0 group-hover:lg:brightness-100 group-hover:lg:scale-105"
          />
