...
export const Title = () => (
  ...
  >
    ...
    <div
      className="relative min-h-75 w-full max-w-275 border border-green-900/50 bg-green-950/5 p-12 rounded-sm shadow-[inset_0_0_20px_rgba(0,0,0,0.8)] overflow-hidden"
    ...
    >
      ...
      <img
        className="absolute -right-12.5 -top-5 w-125 opacity-40 mix-blend-screen grayscale hover:grayscale-0 hover:opacity-80 transition-all duration-700 pointer-events-none"
        src={Predator}
        alt="Asset-01"
      />
